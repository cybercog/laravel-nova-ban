# Contributing to Laravel Nova Ban
...
We are trying to keep backwards compatibility breaks in Laravel Nova Ban to an absolute minimum. Please take this into account when proposing changes.
